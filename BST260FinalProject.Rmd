...
lowcities <- data.frame(Country = c("Venezuela", "Haiti", "South Sudan", "Ukraine", "India"), 
    lat = c(6.4238, 18.9715, 6.8770, 48.3794, 20.5937), 
    lng = c(-66.5897, -72.2852, 31.3070, 31.1656, 78.9629),
...
ggplot() +
  ...
  geom_text_repel(data = mostleast, aes(x = lng, y = lat, label = Country, color = level), 
                  size = 3,
                  fontface = "bold",
                  nudge_x = c(25, -1.5, 15, -13, -40, -16, 8, 3, 46, 3, -9),
                  nudge_y = c(-5, -15, 7, 3, -7, 13, 10, 7, -3, 26, -4),
