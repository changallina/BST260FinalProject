...
topcities <- data.frame(Country = c("Taiwan", "Australia", "Mauritius", "Chile", "Canada", "Finland"), 
    lat = c(24.52212, -43.23242, -20.48486, -55.88965, 43.93960, 60.04068), 
    lng = c(118.4074, 147.3488, 57.65127, -67.57520, -59.78760, 20.61133))
...
ggplot() +
  ...
  geom_text_repel(data = topcities, aes(x = lng, y = lat, label = Country), 
                  size = 3, 
                  fontface = "bold",
                  nudge_x = c(5, -1.5, 2, 8, 0, -1),
                  nudge_y = c(0.25, -0.25, 0.75, 0.75, -0.5, -0.5)) +
