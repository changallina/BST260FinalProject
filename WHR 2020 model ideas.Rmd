...
We also visualized happiness across the years as well as the relation of the Ladder Score to other variables in a Shiny app format (https://changallina.shinyapps.io/bst260finalproject/).
...
# Data Analysis: Regression and Random Forest
...
We find that GDP per capita may be highly correlated with social support, life expectancy, and freedom to make life choices. It may be a good idea to stratify by GPD per capital to see if the relationship between these variable and Cantril Ladder score changes.
...
* In some years, the coefficients of either social support, life expectancy, or freedom to make life choices that were believed to be correlated with GDP per capita became insiginficant due to stratification on GDP per capita and their collinearity.
* The coefficient of generosity was originally insignificant in the models across 2015 - 2019. After restricting to the stratum of the highest GDP per capita, it is now significant in the models in 2015 - 2018. This may indicate that among the higher income countries in the world, generosity level may have significant influence on happiness level, where as in lower income countries generosity may be a minor factor affecting happiness.
...
```
The result of the model showed that only the highest GDP per capita has a signficant coefficient compared to the lowest GDP per capita. Category 1 and 2 showed no difference of their effect on Cantril Ladder score compared to the lowest category. The coefficients of social support, life expectancy, and freedom to make life choices remained significant as the model with continous GDP per capita variable. Note that according to R-squared value, this model (adj-R2 = 0.7555) performs better than the original model(adj-R2 = 0.738).
